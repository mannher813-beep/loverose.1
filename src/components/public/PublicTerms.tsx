  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 space-y-8 text-left">
      <div className="text-center space-y-4">
        ...
        <h1 className="u-display text-3xl text-slate-950 tracking-tight">Conditions Générales d'Utilisation (CGU)</h1>
      ...
      <div className="bg-white border border-slate-100 rounded-3xl p-8 shadow-sm space-y-6 text-xs sm:text-sm text-slate-600 leading-relaxed font-medium">
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-xs">
            ...
            <li>Un système de mise en relation permettant à un membre de proposer un service payant via une annonce, avec paiement direct entre acheteur et vendeur.</li>
          </ul>
        </section>
